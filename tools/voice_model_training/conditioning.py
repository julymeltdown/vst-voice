...
def build_conditioning(label: dict, score: dict, *, vocabulary: list[str],
                       minimum_confidence: float, maximum_frames: int = 65536) -> dict:
    ...
    return dict(formatId="com.project-seam.training-frame-conditioning", schemaVersion=1,
                ...
                language=score["language"], frames=rows, trainingAdmitted=False, releaseEligible=False)
