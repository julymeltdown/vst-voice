...
class WindowsSourceContractTests(unittest.TestCase):
    def test_unicode_entry_and_single_instance_forwarding_exist(self) -> None:
        ...
        self.assertIn("UIA_HelpTextPropertyId", accessibility)
        ...
        self.assertIn("public IRawElementProviderSimple", accessibility)
        self.assertIn("public IRawElementProviderFragment,", accessibility)
        self.assertIn("index_ != 0", accessibility)
