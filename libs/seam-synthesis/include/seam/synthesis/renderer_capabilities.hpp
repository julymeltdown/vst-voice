...
// actually run instead of for a hint the carrier does not have. The formant, breathiness and tension
// channels are where the two answers differ today: the source-filter engine owns its own resonances and
// its own excitation, and a concatenative bank owns neither.
