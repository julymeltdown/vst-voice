...
struct EditorSceneLayout final {
  ...
  double characterDockNameFontSize{11.0};
  double characterDockDetailFontSize{10.0};
  ...
  double pitchEmptyTextFontSize{10.5};
  ...
  double projectRevisionFontSize{10.5};
  ...
  double panelInstructionFontSize{10.5};
  double panelInstructionBaselineOffset{28.0};
  double panelSecondaryInstructionFontSize{10.0};
  ...
  double arrangementActionFontSize{11.0};
  ...
  double regionTextFontSize{11.0};
  ...
  double audioSettingsFontSize{10.0};
  ...
  double voicebankCardFontSize{10.0};
  ...
  double supportPanelFontSize{11.0};
  ...
  double supportTrackNavFontSize{10.5};
  ...
  double microscopeContextFontSize{10.0};
  double microscopeCloseFontSize{10.0};
  ...
  double microscopePlotLabelFontSize{10.0};
  ...
  double microscopeMarkerLabelFontSize{10.0};
  ...
  double runtimeOverlayDetailFontSize{11.0};
  ...
  double runtimeOverlayHostFontSize{11.0};
  ...
  double phase12BDetailFontSize{11.0};
  ...
  double phase12BAlternativeFontSize{10.5};
