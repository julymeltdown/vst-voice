...
from tools.external_beta.evidence_audit import audit_candidate, load_json  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Audit one External Beta candidate against restored raw evidence")
