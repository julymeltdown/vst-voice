...
from tools.external_beta.host_evidence import load_json, validate_host_record  # noqa: E402


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Validate one External Beta host-session record")
    parser.add_argument("--matrix", type=Path, default=ROOT / "docs/product/external-beta-host-matrix.json")
