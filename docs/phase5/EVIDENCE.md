...
If an interrupted sanitizer or CI run already produced validated logs, resume without deleting them:

```bash
python3 scripts/generate_phase5_evidence.py --root . --skip-build --resume
```
